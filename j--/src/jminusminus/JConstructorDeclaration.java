...
class JConstructorDeclaration extends JMethodDeclaration implements JMember {
    ...
    // This is an arraylist needed to convert the exceptions list
    // of type TypeName to an array list of strings
    ...
    public JAST analyze(Context context) {
        ...
        // I am converting the list of excpetions from type name to
        // a list that will contain the string represantation of their jvm name
        for (TypeName exception: exceptions) {
            excep.add(exception.jvmName());
        }
        if (body != null) {
    ...
    public void partialCodegen(Context context, CLEmitter partial) {
        // changes the null value of the exceptions argument in the
        // call of the addMethod method to excep string arraylist
        partial.addMethod(mods, "<init>", descriptor, excep, false);
    ...
    public void codegen(CLEmitter output) {
        // changes the null value of the exceptions argument in the
        // call of the addMethod method to excep string arraylist
        output.addMethod(mods, "<init>", descriptor, excep, false);
        if (!invokesConstructor) {
