...
class Conversions {
    ...
    public Conversions() {
        ...
        // Here I added some conversions from int to long, int to double, long to int,
        // long to double, double to int, and double to long.
        ...
        // the long can always be cast to a Long. The Long simply encapsulates the long
        put(Type.LONG, Type.BOXED_LONG, new Boxing(Type.LONG, Type.BOXED_LONG));
        // Similarly for the double being encapsulated in the Double.
        ...
        put(Type.BOXED_BOOLEAN, Type.BOOLEAN, new UnBoxing(Type.BOXED_BOOLEAN, Type.BOOLEAN,
                "booleanValue"));
        // A Long must be a cast to a long using unboxing, this way we are "plucking out the encapsulated
        // long.
        put(Type.BOXED_LONG, Type.LONG, new UnBoxing(Type.BOXED_LONG, Type.LONG, "longValue"));
        // Similarly for double and Double.
...
// After this point I added some extra converters. Those include: int to long, int to double, long to int,
// long to double, double to int, double to long.
/**
