        ...
        if (iDefn instanceof LocalVariableDefn) {
            ...
            if (type.isReference()) {
                ...
                if (type == Type.INT || type == Type.BOOLEAN || type == Type.CHAR) {
                    ...
                    // Here I added the primitive type long for load instructions
                    ...
                    // Here I added the primitive type double for load instructions
    ...
    public void codegenStore(CLEmitter output) {
        if (iDefn instanceof LocalVariableDefn) {
            ...
            if (type.isReference()) {
                ...
                // I added the primitive type Long here. I looked through the INT, BOOLEAN, and CHAR
                // primitive types above and I used the same idea to implement the LONG by just changing
                // the ISTORE to LSTORE
                } else if (type == Type.LONG) {
                    switch(offset) {
                        case 0:
                    ...
                    // I added the primitive type DOUBLE here. I looked through the INT, BOOLEAN, and CHAR
                    // primitive types, above, and I used the same idea to implement the DOUBLE by just changing
                    // the ISTORE to DSTORE
                } else if (type == Type.DOUBLE) {
                    switch(offset) {
                        case 0:
