...
class JClassDeclaration extends JAST implements JTypeDecl {
    ...
    public void codegen(CLEmitter output) {
        // Added an arraylist of type string for the interface
        interfaces = new ArrayList<String>();
        // add the names of the interfaes in the arraylist superInterfaces in a string array
        // in order to give this argument below
        if (superInterfaces != null) {
            for (TypeName inter : superInterfaces) {
                if (interfaces != null) {
                    interfaces.add(inter.jvmName());
                }
            }
        }
        // The class header.
